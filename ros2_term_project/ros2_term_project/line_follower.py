...
class LineFollower(Node):
    def __init__(self, line_tracker: LineTracker):
        ...
        if self.car_choice == 'PR002':
            ...
            self._subscription3 = self.create_subscription(Image, '/camera1/image_raw', self.actor_collusion_callback,
                                                           10)
        ...
        if self.car_choice == 'PR001':
            ...
            self._subscription6 = self.create_subscription(Image, '/camera3/image_raw', self.actor_collusion_callback,
                                                           10)
